...
do
    ...
    outdir=${outLoc}/${DWIName}
    if [ ! -d ${outdir} ] ; then
        mkdir -p ${outdir}
    fi
    outdirT1w=${outLoc}/Struct_preproc/T1w/${DWIName}
    if [ ! -d ${outdirT1w} ] ; then
        mkdir ${outdirT1w}
    fi
...
#### Copy raw data to working directory ####
    if [ ! -f ${rawdir}/RL_BLIP_input.nii.gz ] ; then
        ...
        cp -r ${outLoc}/DTI_BLIP_RL/*.nii.gz ${rawdir}/${basePos}_BLIP_input.nii.gz       
        cp -r ${outLoc}/DTI_BLIP_RL/*.bval ${rawdir}/${basePos}_BLIP_input.bval 
        cp -r ${outLoc}/DTI_BLIP_RL/*.bvec ${rawdir}/${basePos}_BLIP_input.bvec 
        cp -r ${outLoc}/DTI_BLIP_LR/*.nii.gz ${rawdir}/${baseNeg}_BLIP_input.nii.gz 
        cp -r ${outLoc}/DTI_BLIP_LR/*.bval ${rawdir}/${baseNeg}_BLIP_input.bval 
        cp -r ${outLoc}/DTI_BLIP_LR/*.bvec ${rawdir}/${baseNeg}_BLIP_input.bvec
        cp -r ${outLoc}/DTI_B1000/*.nii.gz ${rawdir}/${baseNeg}_EMPTY_B1000_input.nii.gz
        cp -r ${outLoc}/DTI_B1000/*.bval ${rawdir}/${baseNeg}_EMPTY_B1000_input.bval
        cp -r ${outLoc}/DTI_B1000/*.bvec ${rawdir}/${baseNeg}_EMPTY_B1000_input.bvec
        cp -r ${outLoc}/DTI_B2000/*.nii.gz ${rawdir}/${baseNeg}_EMPTY_B2000_input.nii.gz
        cp -r ${outLoc}/DTI_B2000/*.bval ${rawdir}/${baseNeg}_EMPTY_B2000_input.bval
        cp -r ${outLoc}/DTI_B2000/*.bvec ${rawdir}/${baseNeg}_EMPTY_B2000_input.bvec
        cp -r ${outLoc}/DTI_B3000/*.nii.gz ${rawdir}/${baseNeg}_EMPTY_B3000_input.nii.gz
        cp -r ${outLoc}/DTI_B3000/*.bval ${rawdir}/${baseNeg}_EMPTY_B3000_input.bval
        cp -r ${outLoc}/DTI_B3000/*.bvec ${rawdir}/${baseNeg}_EMPTY_B3000_input.bvec
...
#        cp -r ${i}/DTI_MB3_LR_B3000*/*.bvec ${rawdir}/${baseNeg}_EMPTY_B3000_input.bvec
    ...
    if [ -e ${rawdir}/RL_BLIP_input.nii.gz ] ; then
        ...
        if [ $raw_inputs -eq $check_raw_inputs ] ; then
            echo "${i} Diffusion Basic Preprocessing : Raw Data Copied to Working Directory"
        else
