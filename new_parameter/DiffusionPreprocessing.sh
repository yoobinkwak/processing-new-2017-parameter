...
#### Post Eddy ####
    GDCoeffs=NONE       ## check if it is really NONE
        # path to file containing coefficients that describe spatial variations of the scanner gradients. Use NONE if not available.
    CombineDataFlag=2
