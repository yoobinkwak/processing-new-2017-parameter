...
do
    ...
    do
        ...
        then
            ...
            echo ${i} all b0 extracted for the series
        fi
...
#               ${FSLDIR}/bin/immv ${basename}_new ${basename}
            ...
            echo ${i} mean baseline b0 intensieity for the series processes
        fi
    done
