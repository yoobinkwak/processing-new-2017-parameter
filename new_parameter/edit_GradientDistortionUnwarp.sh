...
FSLDIR=/usr/share/fsl/5.0       ## I added
...
/home/yoobinkwak/preproc_BCS_001_002/gradunwarp-master/gradunwarp/core/gradient_unwarp.py ${BaseName}_vol1.nii.gz trilinear.nii.gz siemens -g $InputCoeffs -n
cd $ORIGDIR
