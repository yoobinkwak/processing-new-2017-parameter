...
HCPPIPEDIR=/home/yoobinkwak/preproc_BCS_001_002/Pipelines-master                     
HCPPIPEDIR_Global=${HCPPIPEDIR}/global/scripts      ## I added
HCPPIPEDIR_Config=${HCPPIPEDIR}/global/config      ## I added
...
${globalscriptsdir}/edit_GradientDistortionUnwarp.sh --workingdir="${datadir}" --coeffs="${GdCoeffs}" --in="${datadir}/data_warped" --out="${datadir}/data" --owarp="${datadir}/fullWarp"
